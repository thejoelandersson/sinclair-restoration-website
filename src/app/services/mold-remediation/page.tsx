      ...
      <div className="mx-auto max-w-[1440px] px-6 lg:px-8 pt-10 pb-24 lg:pt-16 lg:pb-32">
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-10 xl:gap-16 lg:gap-y-16">
          ...
          <section className="max-w-[600px]">
            <h1 className="text-[clamp(38px,4vw,44px)] font-bold tracking-[-0.01em] leading-[1.1] text-heading">Mold Remediation</h1>
            <div className="mt-4 space-y-6 text-[17px] leading-[1.5] text-[var(--sin-neutral-500)]">
              <p><strong className="text-heading">What you get:</strong> Moisture diagnostics • Containment/negative air (as needed) • Removal where required • HEPA & surface treatment • Independent clearance available</p>
              <p><strong className="text-heading">Typical timeline:</strong> Small 1–2 days • Larger 3–5 days</p>
            </div>
          </section>
